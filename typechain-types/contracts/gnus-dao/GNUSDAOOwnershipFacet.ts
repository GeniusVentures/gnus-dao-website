...
export interface GNUSDAOOwnershipFacetInterface extends Interface {
	getFunction(
		nameOrSignature:
			| 'DEFAULT_ADMIN_ROLE'
			| 'UPGRADER_ROLE'
...
export interface GNUSDAOOwnershipFacet extends BaseContract {
	connect(runner?: ContractRunner | null): GNUSDAOOwnershipFacet;
	waitForDeployment(): Promise<this>;

	interface: GNUSDAOOwnershipFacetInterface;
