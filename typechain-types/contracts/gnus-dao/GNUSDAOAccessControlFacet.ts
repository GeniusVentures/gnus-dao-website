...
export interface GNUSDAOAccessControlFacetInterface extends Interface {
	getFunction(
		nameOrSignature:
			| 'DEFAULT_ADMIN_ROLE'
			| 'UPGRADER_ROLE'
...
export interface GNUSDAOAccessControlFacet extends BaseContract {
	connect(runner?: ContractRunner | null): GNUSDAOAccessControlFacet;
	waitForDeployment(): Promise<this>;

	interface: GNUSDAOAccessControlFacetInterface;
