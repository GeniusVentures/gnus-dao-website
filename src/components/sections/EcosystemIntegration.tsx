      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            A global network of devices, developers, and token holders working
            together to democratize AI computing through decentralized
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {ecosystemComponents.map((component, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 ${component.bgColor} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
        ...
        <div className="bg-muted/30 rounded-2xl p-8 mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              From AI task submission to reward distribution, see how our
              decentralized network processes workloads and compensates
              contributors
            </p>
          </div>
        ...
        <div className="text-center bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl p-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Every participant in the GNUS.AI ecosystem has a voice in shaping
              the network's future. From GPU providers to AI developers, all
              stakeholders can propose and vote on network improvements, reward
              structures, and technical upgrades using quadratic voting for fair
              representation.
            </p>
